        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto w-full max-w-3xl px-4 py-8">
                ...
                <div className="space-y-1">
                    {mockTasks.map((task) => (
                        <div key={task.id} className="group flex items-start gap-3 border-b border-gray-100 dark:border-gray-800 py-3 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-sm px-2 -mx-2 cursor-pointer">
                            ...
                            <div className="flex-1">
                                <p className={`text-sm ${task.done ? 'text-gray-400 line-through' : 'text-gray-900 dark:text-gray-100'}`}>
                                    {task.title}
                                </p>
