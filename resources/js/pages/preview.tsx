...
export default function Preview() {
 ...
 <div className="bg-foreground text-background text-center text-xs font-semibold py-2 px-4">
 PREVIEW ONLY — not live, not indexed, for internal review
 </div>
