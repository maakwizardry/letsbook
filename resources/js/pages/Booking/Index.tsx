...
export default function BookingWizard({ provider }: { provider: any }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#121212] flex flex-col font-sans selection:bg-primary/20">
                    ...
                    <div className="flex items-center gap-3">
                        {step > 1 && step < 5 ? (
                            <button 
                                ...
                                className="p-2 -ml-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors active:scale-95"
                            >
            ...
            <main className="flex-1 max-w-2xl mx-auto w-full pb-28">
                ...
                {step === 1 && (
                    <div className="p-4 animate-in fade-in slide-in-from-right-4 duration-300">
                        <div className="mb-6">
                            <h2 className="text-2xl font-extrabold text-gray-900 dark:text-white mb-1">Welcome to {provider.name}</h2>
                            <p className="text-gray-500 dark:text-gray-400 text-sm">What kind of property needs cleaning?</p>
                        </div>
                        <div className="space-y-4">
                            {homeTypes.map(type => (
                                <button
                                    ...
                                    className="w-full flex items-center p-4 bg-white dark:bg-[#1C1C1C] rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all active:scale-[0.98] group"
                                >
                                    <div className="w-12 h-12 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center mr-4 group-hover:bg-primary/10 transition-colors">
                                        <MapPin className="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-primary transition-colors" />
                                    </div>
                                    <div className="flex-1 text-left">
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{type.label}</h3>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-1">{type.description || 'Standard cleaning for this property size.'}</p>
                                    </div>
                ...
                {step === 2 && (
                    <div className="p-4 animate-in fade-in slide-in-from-right-4 duration-300">
                        <div className="mb-6">
                            <h2 className="text-2xl font-extrabold text-gray-900 dark:text-white mb-1">Add Services</h2>
                            <p className="text-gray-500 dark:text-gray-400 text-sm">Customize your cleaning package.</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            {serviceItems.map(item => {
                                ...
                                return (
                                    <div key={item.id} className="flex p-4 bg-white dark:bg-[#1C1C1C] rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden">
                                        ...
                                        <div className="flex-1 pr-4">
                                            ...
                                            <div className="text-xs text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wide font-medium">{item.category}</div>
                                        ...
                                        <div className="flex flex-col items-end justify-center">
                                            {qty === 0 ? (
                                                ...
                                                <div className="flex items-center bg-gray-50 dark:bg-gray-800 rounded-full border border-gray-200 dark:border-gray-700">
                                                    <button 
                                                        onClick={() => handleRemoveService(item.id)}
                                                        className="w-9 h-9 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-primary transition-colors active:scale-90"
                                                    >
                                                        <Minus className="w-4 h-4" />
                                                    </button>
                                                    <span className="w-6 text-center font-semibold text-gray-900 dark:text-white text-sm">{qty}</span>
                                                    <button 
                                                        onClick={() => handleAddService(item.id)}
                                                        className="w-9 h-9 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-primary transition-colors active:scale-90"
                                                    >
                ...
                {step === 3 && (
                    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="bg-white dark:bg-[#1C1C1C] pt-6 pb-4 border-b border-gray-100 dark:border-gray-800 sticky top-14 z-40">
                            <div className="px-4 mb-4 flex items-center justify-between">
                                <h2 className="text-xl font-extrabold text-gray-900 dark:text-white">When do you need us?</h2>
                                ...
                                {dates.map((d, i) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-shrink-0 w-[4.5rem] p-3 rounded-2xl border-2 flex flex-col items-center justify-center snap-start transition-all active:scale-95 ${
                                                isSelected 
                                                ? 'border-primary bg-primary/5 shadow-sm' 
                                                : 'border-gray-100 dark:border-gray-800 bg-white dark:bg-[#1C1C1C] hover:border-gray-200'
                                            }`}
                                        >
                                            <span className={`text-xs uppercase font-semibold mb-1 ${isSelected ? 'text-primary' : 'text-gray-500'}`}>
                                                {d.isToday ? 'Today' : d.dayLabel}
                                            </span>
                                            <span className={`text-xl font-bold ${isSelected ? 'text-primary' : 'text-gray-900 dark:text-white'}`}>
                                                {d.dayNumber}
                                            </span>
                                        </button>
                                    )
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                className={`py-3 px-2 rounded-xl text-sm font-semibold border-2 transition-all active:scale-95 flex items-center justify-center ${
                                                                    !slot.available 
                                                                    ? 'bg-gray-50 dark:bg-gray-800/50 border-transparent text-gray-400 dark:text-gray-500 line-through cursor-not-allowed'
                                                                    : isSelected
                                                                    ? 'bg-primary border-primary text-white shadow-md shadow-primary/20'
                                                                    : 'bg-white dark:bg-[#1C1C1C] border-gray-100 dark:border-gray-800 text-gray-700 dark:text-gray-200 hover:border-gray-300'
                                                                }`}
                                                            >
                                                                {slot.label}
                                                            </button>
                ...
                {step === 4 && (
                    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                        {/* Receipt Summary */}
                        <div className="bg-white dark:bg-[#1C1C1C] p-6 border-b border-gray-100 dark:border-gray-800">
                            <h2 className="text-xl font-extrabold text-gray-900 dark:text-white mb-4">Summary</h2>
                                    ...
                                    return (
                                        <div key={id} className="flex justify-between items-start text-sm">
                                            <div className="flex-1">
                                                <span className="font-semibold text-gray-900 dark:text-white">{qty}x {item.name}</span>
                                            </div>
                                            <div className="font-medium text-gray-900 dark:text-white">${item.price * qty}</div>
                                        </div>
                                    )
                                })}
                            </div>
                            ...
                            <div className="pt-4 border-t border-dashed border-gray-200 dark:border-gray-700 flex justify-between items-center">
                                <span className="font-bold text-gray-900 dark:text-white text-lg">Total to pay</span>
                                <span className="font-black text-2xl text-gray-900 dark:text-white">${totalQuote}</span>
                            </div>
                        </div>

                        {/* User Details Form */}
                        <div className="p-4 pt-6 space-y-5">
                            <h2 className="text-xl font-extrabold text-gray-900 dark:text-white">Your Details</h2>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full pl-11 pr-4 py-4 bg-white dark:bg-[#1C1C1C] border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all shadow-sm font-medium placeholder:font-normal"
                            ...
                            <div>
                                <textarea 
                                    ...
                                    className="w-full p-4 bg-white dark:bg-[#1C1C1C] border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all shadow-sm resize-none h-24"
                ...
                {step === 5 && (
                    <div className="flex flex-col items-center justify-center py-16 px-4 animate-in zoom-in-95 duration-500">
                        ...
                        <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-3">Booking Confirmed!</h2>
                        
                        <div className="bg-white dark:bg-[#1C1C1C] rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm w-full mb-8">
                            <div className="flex justify-between items-center mb-4 pb-4 border-b border-gray-100 dark:border-gray-800">
                                <span className="text-gray-500">Reference ID</span>
                                <span className="font-mono font-bold text-gray-900 dark:text-white">{bookingResponse?.reference_id}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-gray-500">Total</span>
                                <span className="font-bold text-gray-900 dark:text-white">${bookingResponse?.total_quote}</span>
                            </div>
                        </div>

                        <p className="text-gray-500 dark:text-gray-400 text-center mb-8 max-w-sm">
                            Thank you, <span className="font-semibold text-gray-900 dark:text-white">{customer.name}</span>. Your service is scheduled. We've sent details to your email.
                        </p>
                        
                        <button 
                            onClick={() => window.location.reload()}
                            className="w-full py-4 bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-bold rounded-xl active:scale-95 transition-all shadow-xl"
                        >
            ...
            {step > 1 && step < 5 && (
                <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-[#121212]/80 backdrop-blur-md border-t border-gray-200/50 dark:border-gray-800/50 z-50 animate-in slide-in-from-bottom-full duration-300">
                    <div className="max-w-2xl mx-auto flex items-center gap-4">
                        {step === 2 && (
                            <>
                                <div className="flex-shrink-0 w-12 h-12 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center relative">
                                    <ShoppingCart className="w-5 h-5 text-gray-600 dark:text-gray-300" />
                                    {totalItems > 0 && (
                                        <div className="absolute -top-2 -right-2 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs font-bold border-2 border-white dark:border-[#121212]">
                                            {totalItems}
                                        </div>
                                    )}
                                </div>
                                <div className="flex-1">
                                    ...
                                    <div className="text-xl font-black text-gray-900 dark:text-white">${totalQuote}</div>
                                </div>
                                <button 
